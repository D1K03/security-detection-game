...
VulnType = Literal["xss", "sqli", "ssrf", "rce", "path_traversal", "command_injection", "none"]
Language = Literal["javascript", "python", "java", "go", "php"]
SystemName = Literal["O2", "Navigation", "Shields", "Reactor", "Communications", "Electrical", "Medbay", "Security", "Weapons", "Admin"]
